      ...
      <div className="max-w-4xl mx-auto text-center space-y-12">
        <div className="space-y-6">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Your intelligent cooking assistant that helps you create amazing meals, 
            find ingredient substitutes, and plan your weekly menu with ease.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          <Card className="border-2 border-orange-100 hover:border-orange-200 transition-colors">
            ...
            <CardContent>
              <p className="text-sm text-gray-500">
                Simply add 4 or more ingredients from your pantry and let our AI create 
          ...
          <Card className="border-2 border-green-100 hover:border-green-200 transition-colors">
            <CardHeader>
              ...
              <CardTitle>Ingredient Substitute</CardTitle>
              <CardDescription>
            ...
            <CardContent>
              <p className="text-sm text-gray-500">
                Missing an ingredient? Get smart suggestions for substitutes that will 
                work perfectly in your recipe.
              </p>
            </CardContent>
          </Card>
        ...
        <div className="pt-8">
          <p className="text-gray-500">
            Get started by selecting one of the tools from the navigation menu above
          </p>
        </div>
      </div>
    </div>
